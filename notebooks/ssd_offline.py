...
# 安卓实时
# url = 'rtsp://admin:admin@10.195.8.135:8554/live'
...
out = cv2.VideoWriter('E:/project/detection/SSD-Tensorflow/results/test2.avi', fourcc, fps, size, True)  ## 台式机路径
# out = cv2.VideoWriter('D:/project/detection/SSD-Tensorflow/results/test1.avi', fourcc, fps, size, True)
#out = cv2.VideoWriter('D:/project/detection/SSD-Tensorflow/results/test.avi', fourcc, 30.0, size, True)   ##本机摄像头
