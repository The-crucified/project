...
save_path_text = r'E:\project\detection\SSD-Tensorflow_gw\Flask\static\result'
# List = {}
...
def bboxes_draw_on_img(img, classes, scores, bboxes, colors=dict(), thickness=2):
    test = open(save_path_text + '/video_off.txt', 'w')  # 将检测的文字说明进行保存
    test.truncate()  # 清空文件
...
def plt_bboxes(img, classes, scores, bboxes, figsize=(10, 10), linewidth=1.5):
    ...
    for i in range(classes.shape[0]):
        ...
        if cls_id >= 0:
            ...
            #### added 20180516#####
            class_name = bboxes_draw_on_img.num2class(cls_id)
