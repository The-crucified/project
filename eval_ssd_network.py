...
tf.app.flags.DEFINE_string(
    ...
    'checkpoint file.')
tf.app.flags.DEFINE_string(
    'eval_dir', './results', 'Directory where the results are saved to.')
tf.app.flags.DEFINE_integer(
...
tf.app.flags.DEFINE_string(
    'dataset_dir', r'F:/Datas/VOC/tfrecords/tfrecords_test_2007', 'The directory where the dataset files are stored.')
tf.app.flags.DEFINE_string(
